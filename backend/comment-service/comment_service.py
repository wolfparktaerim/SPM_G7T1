...
class CommentService:
    ...
    def update_comment_thread(self, update_data):
        """
        Update an existing comment thread (add reply or update status)
        ...
        Args:
            update_data: dict with keys:
                ...
                - active: bool (optional, to update active status)
        ...
        if 'active' in update_data:
            thread['active'] = update_data['active']
        
        # Add new comment to thread if comment data provided
        if 'comment' in update_data and 'user_id' in update_data and 'creation_date' in update_data:
            new_comment = [
                update_data['user_id'],
                update_data['comment'],
