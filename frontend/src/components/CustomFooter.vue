      ...
      <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
        ...
        <div class="md:col-span-2">
          ...
          <p class="text-gray-300 mb-4 max-w-md">
            Streamlining company operations with comprehensive project management,
        ...
        <!-- Quick Links -->
        <div>
          <h3 class="text-sm font-semibold text-gray-200 tracking-wider uppercase mb-4">
            Quick Links
          </h3>
          <ul class="space-y-3">
            <li>
              <router-link to="/auth" class="text-gray-300 hover:text-white transition-colors duration-200">
                Login / Register
              </router-link>
            </li>
            <li>
        ...
        <div>
          ...
          <ul class="space-y-3">
            <li>
              <a href="mailto:support@g7t1.com" class="text-gray-300 hover:text-white transition-colors duration-200">
                Help Center
              </a>
            </li>
            <li>
